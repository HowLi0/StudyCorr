...
int CalibrationDialog::CalibrationIndex = 1;

//****************************************************CalibrationDialog****************************************************//
CalibrationDialog::CalibrationDialog(QWidget* parent,int CalibrationIndex)
    : QDialog(parent)
{
    this->setWindowTitle(QString("标定对话框"));
...
void CalibrationDialog::SetupUi()
{
    ...
    QString name = QString("Calibration%1").arg(CalibrationIndex);
